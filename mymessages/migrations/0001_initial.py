...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mymessages_message', (
            ...
            ('expire_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 7, 0, 0), null=True)),
    ...
    models = {
        ...
        u'mymessages.message': {
            ...
            'expire_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 7, 0, 0)', 'null': 'True'}),
