...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteView.share_site'
        db.add_column(u'myanalytics_siteview', 'share_site',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteView.share_site'
        db.delete_column(u'myanalytics_siteview', 'share_site')
    ...
    models = {
        ...
        u'myanalytics.siteview': {
            ...
            'share_site': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
