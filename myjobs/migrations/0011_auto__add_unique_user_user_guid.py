...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'User', fields ['user_guid']
        db.create_index(u'myjobs_user', ['user_guid'])

        # Adding unique constraint on 'User', fields ['user_guid']
        db.create_unique(u'myjobs_user', ['user_guid'])


    def backwards(self, orm):
        # Removing unique constraint on 'User', fields ['user_guid']
        db.delete_unique(u'myjobs_user', ['user_guid'])

        # Removing index on 'User', fields ['user_guid']
        db.delete_index(u'myjobs_user', ['user_guid'])
