...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'myjobs_user_user_permissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'myjobs.user'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(u'myjobs_user_user_permissions', ['user_id', 'permission_id'])


    def backwards(self, orm):
        # Removing M2M table for field user_permissions on 'User'
        db.delete_table('myjobs_user_user_permissions')
