...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.user_guid'
        db.add_column(u'myjobs_user', 'user_guid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.user_guid'
        db.delete_column(u'myjobs_user', 'user_guid')
    ...
    models = {
        ...
        u'myjobs.user': {
            ...
            'user_guid': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        }
    }
