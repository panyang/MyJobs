...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.opt_in_employers'
        db.add_column(u'myjobs_user', 'opt_in_employers',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.opt_in_employers'
        db.delete_column(u'myjobs_user', 'opt_in_employers')
