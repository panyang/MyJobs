...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.profile_completion'
        db.add_column(u'myjobs_user', 'profile_completion',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.profile_completion'
        db.delete_column(u'myjobs_user', 'profile_completion')
