...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'myjobs_user', 'gravatar',
                      self.gf('django.db.models.fields.EmailField')(db_index=True, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.gravatar'
        db.delete_column(u'myjobs_user', 'gravatar')
