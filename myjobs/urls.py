...
editpatterns = patterns('MyJobs.myjobs.views',
                        ...
                        url(r'^communication$', 'edit_communication',
...
urlpatterns = patterns('MyJobs.myjobs.views',
                       ...
                       url(r'^batch$', 'batch_message_digest',
                           name='batch_message_digest'),
                       url(r'^success/$', Success.as_view(), name='success'),
                       url(r'^(?P<user_email>(\S+))/account/',
                           include(accountpatterns)),
                       url(r'^(?P<user_email>(\S+))/edit/',
                           include(editpatterns)),
                       url(r'^(?P<user_email>(\S+))/send/$',
                           'continue_sending_mail',
