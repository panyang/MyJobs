$(document).ready(function(){    
    var str = '<link rel="stylesheet" type="text/css" href="http://my.jobs/files/static/saved-search.css">'; 
    str+= '<div id="direct_savedsearch"><a href="http://my.jobs/"><h3>Save This Search</h3></a>';
...
function savedsearch_object(ss_box){
    ...
    */
    ...
    ssearch.msg = "";
    ssearch.email = "";
    ssearch.api_root = "http://my.jobs:80"
