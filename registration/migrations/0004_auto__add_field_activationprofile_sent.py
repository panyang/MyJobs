...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivationProfile.sent'
        db.add_column(u'registration_activationprofile', 'sent',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivationProfile.sent'
        db.delete_column(u'registration_activationprofile', 'sent')
    ...
    models = {
        ...
        u'registration.activationprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sent': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
