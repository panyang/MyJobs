...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Education.education_level_code'
        db.delete_column(u'myprofile_education', 'education_level_code')

        # Adding field 'Education.education_level'
        db.add_column(u'myprofile_education', 'education_level',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Education.education_level_code'
        db.add_column(u'myprofile_education', 'education_level_code',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)

        # Deleting field 'Education.education_level'
        db.delete_column(u'myprofile_education', 'education_level')
    ...
    models = {
        ...
        u'myprofile.education': {
            ...
            'education_level': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
