...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'myprofile_emaillog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myjobs.User'], null=True)),
        ...
        db.send_create_signal(u'myprofile', ['EmailLog'])

        # Adding field 'Profile.last_response'
        db.add_column(u'myprofile_profile', 'last_response',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding M2M table for field email_log on 'Profile'
        db.create_table(u'myprofile_profile_email_log', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm[u'myprofile.profile'], null=False)),
            ('emaillog', models.ForeignKey(orm[u'myprofile.emaillog'], null=False))
        ))
        db.create_unique(u'myprofile_profile_email_log', ['profile_id', 'emaillog_id'])


    def backwards(self, orm):
        # Deleting model 'EmailLog'
        db.delete_table(u'myprofile_emaillog')

        # Deleting field 'Profile.last_response'
        db.delete_column(u'myprofile_profile', 'last_response')

        # Removing M2M table for field email_log on 'Profile'
        db.delete_table('myprofile_profile_email_log')
    ...
    models = {
        ...
        u'myprofile.emaillog': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['myjobs.User']", 'null': 'True'})
        },
        ...
        u'myprofile.profile': {
            ...
            'email_log': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['myprofile.EmailLog']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
