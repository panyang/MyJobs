...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MilitaryService.service_end_date'
        db.alter_column(u'myprofile_militaryservice', 'service_end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MilitaryService.service_start_date'
        db.alter_column(u'myprofile_militaryservice', 'service_start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'MilitaryService.service_end_date'
        db.alter_column(u'myprofile_militaryservice', 'service_end_date', self.gf('django.db.models.fields.DateField')(default=''))

        # Changing field 'MilitaryService.service_start_date'
        db.alter_column(u'myprofile_militaryservice', 'service_start_date', self.gf('django.db.models.fields.DateField')(default=' '))
