...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Telephone.area_dialing'
        db.alter_column(u'myprofile_telephone', 'area_dialing', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Telephone.extension'
        db.alter_column(u'myprofile_telephone', 'extension', self.gf('django.db.models.fields.CharField')(default='', max_length=5))

        # Changing field 'Telephone.number'
        db.alter_column(u'myprofile_telephone', 'number', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Telephone.country_dialing'
        db.alter_column(u'myprofile_telephone', 'country_dialing', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'Telephone.area_dialing'
        db.alter_column(u'myprofile_telephone', 'area_dialing', self.gf('django.db.models.fields.IntegerField')(max_length=3))

        # Changing field 'Telephone.extension'
        db.alter_column(u'myprofile_telephone', 'extension', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Telephone.number'
        db.alter_column(u'myprofile_telephone', 'number', self.gf('django.db.models.fields.CharField')(max_length=8))
