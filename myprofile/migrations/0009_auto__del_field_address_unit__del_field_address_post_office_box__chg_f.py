...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Address.unit'
        db.delete_column(u'myprofile_address', 'unit')

        # Deleting field 'Address.post_office_box'
        db.delete_column(u'myprofile_address', 'post_office_box')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Address.unit'
        db.add_column(u'myprofile_address', 'unit',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Address.post_office_box'
        db.add_column(u'myprofile_address', 'post_office_box',
