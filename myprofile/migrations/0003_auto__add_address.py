...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'myprofile_address', (
            ...
            ('unit', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            ('city_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('country_sub_division_code', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('country_code', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('postal_code', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('post_office_box', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
        ))
    ...
    models = {
        ...
        u'myjobs.user': {
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 16, 22, 45, 45411)'}),
