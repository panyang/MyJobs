...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Name.display_name'
        db.delete_column(u'myprofile_name', 'display_name')


        # Changing field 'SecondaryEmail.email'
        db.alter_column(u'myprofile_secondaryemail', 'email', self.gf('django.db.models.fields.EmailField')(default='a@foo.com', max_length=255))

    def backwards(self, orm):
        # Adding field 'Name.display_name'
        db.add_column(u'myprofile_name', 'display_name',
