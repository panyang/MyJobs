...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'myprofile_education', 'education_level_code', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Education.education_level_code'
        db.alter_column(u'myprofile_education', 'education_level_code', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'myprofile.education': {
            ...
            'education_level_code': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
