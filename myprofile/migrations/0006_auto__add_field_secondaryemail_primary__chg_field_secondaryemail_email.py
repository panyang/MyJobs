...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SecondaryEmail.primary'
        db.add_column(u'myprofile_secondaryemail', 'primary', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'SecondaryEmail.email'
        db.alter_column(u'myprofile_secondaryemail', 'email', self.gf('django.db.models.fields.EmailField')(default='NULL', max_length=255))


    def backwards(self, orm):
        
        # Deleting field 'SecondaryEmail.primary'
        db.delete_column(u'myprofile_secondaryemail', 'primary')
    ...
    models = {
        ...
        u'myjobs.user': {
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 31, 14, 13, 46, 612907)'}),
