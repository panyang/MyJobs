...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SavedSearch.created_on'
        db.add_column(u'mysearches_savedsearch', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SavedSearch.created_on'
        db.delete_column(u'mysearches_savedsearch', 'created_on')
