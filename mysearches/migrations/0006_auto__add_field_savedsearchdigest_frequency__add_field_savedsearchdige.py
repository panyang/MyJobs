...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SavedSearchDigest.frequency'
        db.add_column(u'mysearches_savedsearchdigest', 'frequency',
                      self.gf('django.db.models.fields.CharField')(default='D', max_length=2),
                      keep_default=False)

        # Adding field 'SavedSearchDigest.day_of_month'
        db.add_column(u'mysearches_savedsearchdigest', 'day_of_month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SavedSearchDigest.day_of_week'
        db.add_column(u'mysearches_savedsearchdigest', 'day_of_week',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SavedSearchDigest.frequency'
        db.delete_column(u'mysearches_savedsearchdigest', 'frequency')

        # Deleting field 'SavedSearchDigest.day_of_month'
        db.delete_column(u'mysearches_savedsearchdigest', 'day_of_month')

        # Deleting field 'SavedSearchDigest.day_of_week'
        db.delete_column(u'mysearches_savedsearchdigest', 'day_of_week')
